...
namespace ranges
{
    inline namespace v3
    {
        ...
        private:
            ...
            template<typename Adapt_, typename base_mixin>
            static meta::id<base_mixin> basic_adaptor_mixin_2_(long);
            template<typename Adapt_, typename base_mixin>
            static meta::id<typename Adapt_::template mixin<base_mixin>> basic_adaptor_mixin_2_(int);

            struct basic_adaptor_mixin_
                : decltype(basic_adaptor_mixin_2_<Adapt, basic_adaptor_mixin>(42))
            {};
